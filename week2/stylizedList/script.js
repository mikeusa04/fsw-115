...
// to go inside the array data and print out the objects
var output = document.getElementById("output");
let ul = document.createElement("ul")
for(var n=0; n < data.length; n++ ){
var list = document.createElement("li");
list.innerHTML = "count: "+ data[n].count +", next: " + data[n].next +", previous: " + data[n].previous
//list.innerHTML = "count: "+ data[0].count;
output.append(list);
//or
/*ul.append(list);
...
//to go inside the nesting array which is (results) we do data[0].results 
var storage = data[0].results;
console.log(storage); // to show that array (results) in the console
// to go inside tha array "results" and print out what we need 
var output = document.getElementById("output"); 
let ol = document.createElement("ol");
for(let i=0; i < storage.length; i++) {
var list = document.createElement("li");
list.textContent = `name: ${storage[i].name}, height: ${storage[i].height}, mass: ${storage[i].mass}, hair_color: ${storage[i].hair_color}, skin_color: ${storage[i].skin_color}, eye_color: ${storage[i].eye_color}, birth_year; ${storage[i].birth_year}, gender: ${storage[i].gender}, homeworld: ${storage[i].homeworld}`;
// or another way to do the step above
//list.innerHTML = "name: "+ storage[i].name +" "+ "height: " + storage[i].height......etc
ol.append(list);
